...
function App() {
  ...
  const [trustedForwarder, setTrustedForwarder] =
    useState("noTrustedForwarder");
  ...
  //"ethersJs setUp"//////////////////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////////////////////////////////////
  const tricketSmartContractAddress =
    "0x753c38D5ebFe0a07ED5b51467CF236700d99E459";
  ...
  const tricketSmartContractInstance = new ethers.Contract(
    tricketSmartContractAddress,
    tricketSmartContractFullAbi,
    provider
  );
  ...
  async function getScData() {
    ...
    let _trustedForwarder =
      await tricketSmartContractInstance.getTrustedForwarder();
  ...
  async function callChangeNormalQuote(paramNewNormalQuote) {
    ...
    const changeNormalQuoteTx = await tricketSmartContractInstance
      .connect(signer)
      .changeQuote(paramNewNormalQuote);
  ...
  return (
    <div>
      ...
      <div>
        <a style={{ marginLeft: "23rem" }}>Address: {userAddress}</a>
      </div>
      ...
      {/*quoteValueDisplay*/}
      <div>
        <a style={{ marginLeft: "11rem" }}>Quote: {quote}</a>
      </div>
      ...
      <div>
        ...
        <div>
          <a style={{ marginLeft: "1rem" }}>
            ...
            <input
              name="normalQuote"
              onChange={(event) => setNormalQuoteInputValue(event.target.value)}
            />
            <button
              type="button"
              onClick={() => callChangeNormalQuote(normalQuoteInputValue)}
            >
              setNewNormalQuote
            </button>
          </a>
        ...
        <div>
          <a style={{ marginLeft: "2rem" }}>
            ...
            <input
              name="metaQuote"
              onChange={(event) => setMetaQuoteInputValue(event.target.value)}
            />
            <button
              type="button"
              onClick={() => callChangeMetaQuote(metaQuoteInputValue)}
            >
              setNewMetaQuote
            </button>
          </a>
